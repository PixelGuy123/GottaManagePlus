    ...
    ManifestLoader manifestLoader)
{
    ...
    {
        _logger.Information("Scanning mod repository on '{profile}'.", profileMetadata);
        // Get BepInEx/Plugins.
        var pluginsPath =
            _controller.SearchAbsolutePath(Constants.BepInExFolderName, Constants.PluginsFolder);
